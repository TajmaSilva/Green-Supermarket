                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-xs-6">
                            <div class="alert alert-info back-widget-set text-center">
                                <i class="fas fa-shopping-cart fa-5x" style="color: #3498db; background-color: #ecf0f1;"></i>
                            <%
                                //Count product query
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-6">
                        <div class="alert alert-success back-widget-set text-center">
                            <i class="fas fa-user fa-5x" style="color: #2ecc71; background-color: #d0f2cc;"></i>
                            <%
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-6">
                        <div class="alert alert-warning back-widget-set text-center">
                            <i class="fas fa-shopping-bag fa-5x" style="color: #f39c12; background-color: #fdf2e9;"></i>
                            <%
                                //Count orders query
